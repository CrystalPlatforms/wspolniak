/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: a4787a54bade0003746ad332518614ce)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "SESSION_SECRET" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD">> {}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "SESSION_SECRET" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "CLOUDFLARE_ENV" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_IMAGES_API_TOKEN" | "CLOUDFLARE_IMAGES_ACCOUNT_HASH">> {}
}

...
import aiEndpoint from "@/hono/api/ai";
import albumsEndpoint from "@/hono/api/albums";
...
import calendarAppEndpoint from "@/hono/api/calendar-app";
...
apiHono.route("/app/albums", albumsEndpoint);
